...
; 0000 0073    UDR=tx_buffer[tx_rd_index++];
	...
	LD   R30,Z
	OUT  0xC,R30
; 0000 0074 #if TX_BUFFER_SIZE != 256
; 0000 0075    if (tx_rd_index == TX_BUFFER_SIZE) tx_rd_index=0;
	LDI  R30,LOW(8)
	CP   R30,R9
	BRNE _0xB
	CLR  R9
...
;void putchar(char c)
; 0000 007F {
; 0000 0080 while (tx_counter == TX_BUFFER_SIZE);
;	c -> Y+0
; 0000 0081 #asm("cli")
; 0000 0082 if (tx_counter || ((UCSRA & DATA_REGISTER_EMPTY)==0))
; 0000 0083    {
; 0000 0084    tx_buffer[tx_wr_index++]=c;
; 0000 0085 #if TX_BUFFER_SIZE != 256
; 0000 0086    if (tx_wr_index == TX_BUFFER_SIZE) tx_wr_index=0;
; 0000 0087 #endif
...
; 0000 009B DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 009C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 009D PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	OUT  0x1B,R30
; 0000 009E 
; 0000 009F // Port B initialization
; 0000 00A0 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 00A1 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
...
; 0000 00A7 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 00A8 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 00A9 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 00AA 
; 0000 00AB // Port D initialization
; 0000 00AC // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 00AD DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
...
; 0000 00B6 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 00DC TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 00DD 
...
; 0000 00E2 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
; 0000 00E3 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 00E4 
; 0000 00E5 // USART initialization
; 0000 00E6 // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 00E7 // USART Receiver: On
; 0000 00E8 // USART Transmitter: On
; 0000 00E9 // USART Mode: Asynchronous
; 0000 00EA // USART Baud Rate: 9600
; 0000 00EB UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00EC UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 00ED UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00EE UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00EF UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 00F0 
...
; 0000 00FC ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00FD 
...
; 0000 0109 // RS - PORTC Bit 4
; 0000 010A // RD - PORTC Bit 5
; 0000 010B // EN - PORTC Bit 6
; 0000 010C // D4 - PORTC Bit 3
; 0000 010D // D5 - PORTC Bit 2
; 0000 010E // D6 - PORTC Bit 1
; 0000 010F // D7 - PORTC Bit 0
; 0000 0110 // Characters/line: 16
; 0000 0111 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0112 
