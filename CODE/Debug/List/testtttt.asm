...
_0x0:
	...
	.DB  0x0,0x48,0x45,0x54,0x20,0x41,0x43,0x20
	.DB  0x51,0x55,0x59,0x0,0x63,0x68,0x75,0x61
	.DB  0x20,0x6E,0x68,0x61,0x6E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 005C 
; 0000 005D       }
; 0000 005E       if(data!='A'&& data!='B' && data!='C')
_0xF:
_0x8:
	CPI  R16,65
	BREQ _0x15
...
; 0000 0092 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 00A1 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 00B1 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 00B2 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	OUT  0x2E,R30
...
; 0000 00C1 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 00C2 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00D3 // USART Transmitter: Off
; 0000 00D4 // USART Mode: Asynchronous
; 0000 00D5 // USART Baud Rate: 9600
; 0000 00D6 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00D7 UCSRB=(1<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(144)
	OUT  0xA,R30
; 0000 00D8 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00D9 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00DA UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 00DB 
...
; 0000 00E7 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00E8 
...
; 0000 00EF TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00F0 
; 0000 00F1 // Alphanumeric LCD initialization
; 0000 00F2 // Connections are specified in the
; 0000 00F3 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 00F4 // RS - PORTC Bit 4
; 0000 00F5 // RD - PORTC Bit 5
; 0000 00F6 // EN - PORTC Bit 6
; 0000 00F7 // D4 - PORTC Bit 3
; 0000 00F8 // D5 - PORTC Bit 2
; 0000 00F9 // D6 - PORTC Bit 1
; 0000 00FA // D7 - PORTC Bit 0
; 0000 00FB // Characters/line: 8
; 0000 00FC lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 00FD 
